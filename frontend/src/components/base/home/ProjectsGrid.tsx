  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {/* Project Item 1 */}
        <div className="project-item bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-all">
        ...
        <div className="project-item bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-all">
          <div className="project-content">
            <h2 className="text-xl font-semibold mb-2">CANopen SDO Sample</h2>
            <p className="text-gray-700 mb-4">
        ...
        <div className="project-item bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-all">
          <div className="project-content">
            <h2 className="text-xl font-semibold mb-2">VHDL Audio Processor</h2>
            <p className="text-gray-700 mb-4">
