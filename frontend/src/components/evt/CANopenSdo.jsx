  ...
  return (
    <Container className="project-content">
      ...
      <p className="lead text-center">
        This project demonstrates communication between two STM32 microcontrollers using the CANopen SDO protocol.
      </p>
      ...
      <Row className="align-items-center">
        <Col md={7}>
          ...
          <ol>
            ...
            <li>Uses the <code>SDOReceive</code> method to request and validate the data.</li>
            <li>Logs errors or success messages via a UART Logger.</li>
          </ol>
        </Col>
        <Col md={5}>
          <Image src={receiveData} fluid alt="receiveData Code" className="hover-image" />
        </Col>
      </Row>
      ...
      <Row className="align-items-center">
        <Col md={7}>
          ...
          <ol>
            ...
            <li>Uses the <code>SDOTransfer</code> method to initiate the data transfer and checks for errors.</li>
            <li>Logs errors or success messages via a UART Logger.</li>
          </ol>
        </Col>
        <Col md={5}>
          <Image src={transferData} fluid alt="transferData Code" className="hover-image" />
        </Col>
      </Row>
      ...
      <Row className="align-items-center">
        <Col md={7}>
          <h2>SDOReceive</h2>
          <p>
            This function initiates an SDO upload (read) request to retrieve data from the target CANopen node.
          </p>
          <ol>
            <li>Uses <code>COCSdoFind</code> to locate the target CANopen node.</li>
            <li>Registers a callback function for completion or errors.</li>
            <li>Sends the upload request and returns any corresponding error codes.</li>
          </ol>
        </Col>
        <Col md={5}>
          <Image src={SDOReceive} fluid alt="SDOReceive Diagram" className="hover-image" />
        </Col>
      </Row>
      ...
      <Row className="align-items-center">
        <Col md={7}>
          <h2>SDOTransfer</h2>
          <p>
            This function prepares and initiates an SDO download (write) request to send data to the target CANopen node.
          </p>
          <ol>
            <li>Uses <code>COCSdoFind</code> to locate the target CANopen node.</li>
            <li>Registers a callback function for monitoring completion or errors.</li>
            <li>Sends the download request and handles any errors that occur.</li>
          </ol>
        </Col>
        <Col md={5}>
          <Image src={SDOTransfer} fluid alt="SDOTransfer Diagram" className="hover-image" />
        </Col>
      </Row>
      ...
      <Row className="align-items-center">
        <Col md={7}>
          ...
          <ol>
            ...
            <li><code>AppContext</code> is a pointer to the CSDO node.</li>
          </ol>
        </Col>
        <Col md={5}>
          <Image src={registerCallBack} fluid alt="registerCallBack Diagram" className="hover-image" />
        </Col>
      </Row>
    </Container>
  );
